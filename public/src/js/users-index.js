...
validationApp.service('Users', function ($http) {

    this.roles = function (user_id) {

        return $http.get('/api/user/roles/' + user_id)
...
validationApp.factory('UserService', function ($http) {


});

validationApp.controller('mainController', ['$scope', '$http', function ($scope, $http, UserService) {
